    ...
    alter table available_rule_fix_rules     drop index UK_na5nkgaqxwfd38hdfq0tk8ke9;

    alter table available_rule_fix_rules 
       add constraint UK_na5nkgaqxwfd38hdfq0tk8ke9 unique (fix_rules_id);
    
    alter table site_rule_actions        drop index UK_2pod5qgkbe6lfe3ma8kth4qpq;
    
    alter table site_rule_actions 
       add constraint UK_2pod5qgkbe6lfe3ma8kth4qpq unique (actions_id);
 
    
    alter table site_rule_rules        drop index UK_gluqjxuy9328haaswpsjwrg5g;
